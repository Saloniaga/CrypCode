...
describe("Transaction", () => {
  ...
  describe("outputMap", () => {
    ...
    it("outputs the remaining balance fo the `senderWallet`", () => {
  ...
  describe("update()", () => {
    ...
    describe("and the amount is valid", () => {
      beforeEach(() => {
        originalSignture = transaction.input.signature;
      ...
      it("re-signs the transaction", () => {
        expect(transaction.input.signature).not.toEqual(originalSignture);
      });
      ...
      describe("and another update for the same recipient", () => {
        ...
        it("adds to the receipient amount", () => {
